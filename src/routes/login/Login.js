...
function Login() {
  ...
  return (
    <div className=" bg-gray-200 h-screen flex-col flex items-center p-1 md:p-0">
      <div className="w-full px-1 mt-10 md:w-6/12 md:4/12"> 
      ...
      <div className="w-full px-1 md:w-6/12 md:4/12">
