                        ...
                        <tr key={stock.idstock}>
                            <td className='flex justify-center'>
                                {permisos.includes("Stock") && (
                                    ...
                                    onClick={() => { navigate(`/printCode/${stock.idstock + stock.repuesto.split(" ")[0].slice(0,2) + stock.repuesto.split(" ")[1].slice(0,1) + stock.repuesto.split(" ")[3] + stock.fecha_compra.slice(0, 10).split("-")[0].slice(2,4) + stock.fecha_compra.slice(0, 10).split("-")[1] + stock.fecha_compra.slice(0, 10).split("-")[2]}`) }} >
                                        Print
                                    </button>
                                )}
                            </td>
